$(function(){
    ...
    function syncDrawingData(data){
        ...
        if(data.textarea_color == 'cyan'){
            document.getElementById("text_area").style.backgroundColor = 'cyan'
        }
    ...
    select_element.addEventListener('chane', select_color)
});